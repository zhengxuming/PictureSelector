...
public abstract class IBridgeMediaLoader {
    ...
    protected String getQueryMimeCondition() {
        ...
        while (iterator.hasNext()) {
            ...
            } else if (getConfig().chooseMode == SelectMimeType.ofAV()) {
                if (value.startsWith(PictureMimeType.MIME_TYPE_PREFIX_VIDEO) || value.startsWith(PictureMimeType.MIME_TYPE_PREFIX_AUDIO)) {
                    continue;
                }
