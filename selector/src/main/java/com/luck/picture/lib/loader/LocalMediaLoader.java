...
public final class LocalMediaLoader extends IBridgeMediaLoader {
    ...
    private static String getSelectionArgsForAllMediaCondition(String timeCondition,
        ...
        String conditionStr="(" +
                ...
                timeCondition + ") AND " +
                sizeCondition;
        Log.i("frag","getSelectionAll------->"+conditionStr);
        return conditionStr;
    }
     ...
     */
    private static String getSelectionArgsForAVMediaCondition(String durationCondition, String queryMimeCondition) {

        String conditionStr=MediaStore.Files.FileColumns.MEDIA_TYPE + "=?" + queryMimeCondition + " OR " +
                MediaStore.Files.FileColumns.MEDIA_TYPE + "=? AND " + durationCondition;

        Log.i("frag","getSelectionAudioAndVideo------->"+conditionStr);
        return conditionStr;
    }
